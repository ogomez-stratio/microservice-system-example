package com.stratio.architecture.microservices.daasWeatherService.config;
...
public class SwaggerConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.stratio.architecture.microservices.daasWeatherService"))
                    .build()
                .apiInfo(apiInfo());
    }
