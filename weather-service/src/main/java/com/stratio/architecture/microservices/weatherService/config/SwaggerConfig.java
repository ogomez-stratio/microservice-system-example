package com.stratio.architecture.microservices.weatherService.config;
...
public class SwaggerConfig {
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("com.stratio.architecture.microservices.weatherService"))
                    .build()
                .apiInfo(apiInfo());
    }
