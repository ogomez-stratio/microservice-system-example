package com.stratio.architecture.microservices.apiweatherservice.controller;
...
import com.stratio.architecture.microservices.apiweatherservice.util.ResponseUtil;
...
public class ApiWeatherController {
  ...
  private static final Logger log = LoggerFactory.getLogger(ApiWeatherController.class);
